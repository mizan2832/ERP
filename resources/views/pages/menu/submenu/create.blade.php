@extends('master')
@section('title','Sub-Menu Creation')
@push('css')
<style>
    .header {
...
<div class="container menu-form">
    ...
    <h4 class="text-center">Sub Menu Create</h4>

    <div class="general">
        <div class="header">
            <span>Sub Menu Form</span>
        </div>
        <div class="container-xxl flex-grow-1 p-4 general-form">
            <div class="row col-md-12 align-items-center">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="sub-menu" class="col-form-label">Sub Manu Name </label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="sub-menu" id="sub-menu">
                            </div>
